...
/opt/microblaze-ace/microblaze-cc -o application function.optim.s main_wtiming.s /opt/lara-tools/larad/targets/microblaze/mulsi3.S /opt/lara-tools/larad/targets/microblaze/muldi3.S /opt/lara-tools/larad/targets/microblaze/modsi3.S
