...
timelimit -t1 /opt/clang+llvm-3.3-Ubuntu-13.04-x86_64-linux-gnu/bin/llc -march=mblaze -mcpu=mblaze5 -mattr=+patcmp,+barrel,+div,+mul,+fpu -O3 function.optim.ll -o function.optim.s
